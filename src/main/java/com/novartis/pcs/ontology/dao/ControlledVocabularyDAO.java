...
import static com.novartis.pcs.ontology.entity.ControlledVocabulary.QUERY_BY_DATASOURCE;
...
public class ControlledVocabularyDAO extends ModifiableEntityDAO<ControlledVocabulary>
    ...
    @Override
    @SuppressWarnings("unchecked")
    public List<ControlledVocabulary> loadByDatasource(Datasource datasource) {
        Query query = entityManager.createNamedQuery(QUERY_BY_DATASOURCE, ControlledVocabulary.class);
