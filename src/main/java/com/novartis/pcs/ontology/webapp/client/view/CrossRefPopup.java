    ...
    */
    ...
    public CrossRefPopup(OntoBrowserServiceAsync service,
        ...
        if (curator != null) {
            ...
            createChildTermButton.addClickHandler(event -> {
    ...
    public List<ControlledVocabularyTerm> getTerms() {
        ...
        if (dialogBox.isShowing()) {
            terms = new ArrayList<>(selection.getSelectedSet());
        }
        return terms;
    }
    ...
    private void addTableColumns() {
	    ...
	    */
        ...
        IconActionCell.Delegate<ControlledVocabularyTerm> delegate = term -> {
        ...
        Column<ControlledVocabularyTerm, ControlledVocabularyTerm> searchColumn =
                new Column<ControlledVocabularyTerm, ControlledVocabularyTerm>(
                        new IconActionCell<>(ImageResources.INSTANCE.searchIcon(), delegate)) {
                    @Override
	    ...
	    */
        ...
        nameColumn.setFieldUpdater((index, term, value) -> linkedTermsView.show(term));
    ...
    private void addDialogWidgets() {
		...
		*/
        ...
        if (curator != null) {
            ...
            excludeButton.addClickHandler(event -> {
                final Set<ControlledVocabularyTerm> selected = selection.getSelectedSet();
                selected.removeAll(processing);
                if (!selected.isEmpty()) {
                    processing.addAll(selected);
