...
@NamedQueries({
        ...
        @NamedQuery(name = ControlledVocabulary.QUERY_BY_NAME,
                ...
                hints = {@QueryHint(name = "org.hibernate.cacheable", value = "true")}),
        @NamedQuery(name = ControlledVocabulary.QUERY_BY_DATASOURCE,
                query = "select cv from ControlledVocabulary as cv where cv.datasource = :datasource",
                hints = {@QueryHint(name = "org.hibernate.cacheable", value = "true")})
})
public class ControlledVocabulary extends ModifiableEntity {
    ...
    public static final String QUERY_BY_DATASOURCE = "ControlledVocabulary.byDatasource";
