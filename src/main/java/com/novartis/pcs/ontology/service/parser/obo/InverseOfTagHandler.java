...
public class InverseOfTagHandler extends OBOTagHandler {

    public InverseOfTagHandler(OBOParseContext context) {
    ...
    void handleTagValue(String tag, String value,
        ...
        RelationshipType inverse = context.getRelationshipType(refId);
        if (!inverse.equals(relationshipType.getInverseOf())) {
            relationshipType.setInverseOf(inverse);
        }
    }
}
