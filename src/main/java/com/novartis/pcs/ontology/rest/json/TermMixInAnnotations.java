...
public interface TermMixInAnnotations extends VersionedEntityMixInAnnotations {
    ...
    @JsonManagedReference("synonyms")
    Set<Synonym> getSynonyms();

    @JsonManagedReference("synonyms")
    void setSynonyms(Set<Synonym> synonyms);

    @JsonManagedReference("relationships")
    Set<Relationship> getRelationships();

    @JsonManagedReference("relationships")
    void setRelationships(Set<Relationship> relationships);

    @JsonManagedReference("crossReferences")
    Set<CrossReference> getCrossReferences();

    @JsonManagedReference("crossReferences")
    void setCrossReferences(Set<CrossReference> crossReferences);
